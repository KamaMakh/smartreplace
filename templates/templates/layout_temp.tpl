{if $content.mode != 'insertToDb' && $content.mode != 'removeElement' && $content.mode != 'addNewGroup' && $content.mode != 'checkScript'}
    ...
    <html lang="ru">
        <head>
            ...
            <script type="text/javascript" src="/assets/js/lib/jquery/3.2.1/jquery-3.2.1.js"></script>
            <script type="text/javascript" src="/assets/js/lib/jquery-reveal/jquery.reveal.js"></script>
